            ...
            if(key=="features")
            {
                ...
                $.each(value, function(cle, valeur)
                {
                    ...
                    if(i==1)
                    {
                        ...
                        $("#createTabqsdqdle").text(createTable);
                    }
                    i++
                    for (var k=0; k<featuresNames.length; k++)
                    {   if(k==0)
                        {
                            insertInto += "('"+valeur.properties[featuresNames[k]]+"', ";
                        }
                ...
                $("#insertIntqsdsqdo").text(insertInto);
            }
        });
    });
...
<html>
    ...
    <body>
        <form method="POST" action="http://localhost/NettoyageFichiers/insertionGeojsonTentativeAjax.php">
